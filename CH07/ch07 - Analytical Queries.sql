...
TradeYear,TradeQtr,TradeMonth,CustId,PortfolioNo
	,PortfolioAccountTypeCode,Portfolio,MonthlyValue
)
AS (
...
DROP INDEX IF EXISTS ieCustIdAcctYearAcctMonthAcctNameAcctName
ON FinancialReports.AccountClustered
GO
