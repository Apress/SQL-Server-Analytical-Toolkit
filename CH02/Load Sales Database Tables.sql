...
/*************************************/
/* Chapter 02,03,04 - Sales Database */
...
/******************************************************************************/
/* Note: before you backup and truncate logs make sure you take a full backup */
/******************************************************************************/
...
SELECT * FROM [DimTable].[ProductCategory]
GO
...
/*************************************************/
/* Load Customer Favority Product Sub Categories */
/*************************************************/

INSERT INTO [StagingTable].[CustomerFavoriteProductSubCategories]
VALUES
('C00000001','PSC0010'),
('C00000001','PSC0202'),
('C00000002','PSC0011'),
...
-- ran approx 21 seconds
-- generated 202,644 row
...
SELECT * FROM [StagingTable].[SalesTransaction]
GO
...
/**********************************************************************************/
/* change the physical file path in case your machine has a different disk layout */
/**********************************************************************************/
/*
BACKUP LOG [APSales]
TO  DISK = N'D:\APRESS_TOOLKIT_DATABASES\AP_SALES_BACKUP\AP_SALES_BAKUP.LOG' 
WITH NOFORMAT,INIT,  
...
DROP INDEX IF EXISTS ieFactCalendarDate
...
DROP INDEX IF EXISTS ieSalesCalendarDate 
ON [DimTable].[Calendar]
GO
...
/***********************************/
/* 202644 rows loaded in 1 second. */
/***********************************/
...
DROP INDEX IF EXISTS [ieSalesFact] ON [FactTable].[Sales] 
GO
...
SELECT DISTINCT C.CustomerFullName
  ...
  SELECT * FROM [SalesReports].[YearlySalesReport]
  GO
...
DROP INDEX IF EXISTS pkFactSales
ON FactTable.Sales
GO
...
DROP INDEX IF EXISTS akSalesCalendarKey
ON DimTable.[Calendar]
GO
...
DELETE FROM [SalesReports].[MemorySalesTotals]
GO
