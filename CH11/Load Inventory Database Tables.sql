...
/*****************************************/
/* Chapter 11,12,13 - Inventory Database */
/* Load Tables                           */
/* Created: 08/19/2022                   */
/* Modified: 07/20/2023                  */
/* Production                            */
...
will be initialized in one of the query scripts
*/
...
SELECT * FROM [MasterData].[Country]
GO
...
SELECT * FROM [ApInventory].[Product].[InventoryTransaction]
GO
...
SELECT * FROM Product.InventorySalesReport
GO
...
/***********************************/
/* Load Inventory Movement History */
/***********************************/

TRUNCATE TABLE [Product].[InventoryMovementHistory]
GO

INSERT INTO [Product].[InventoryMovementHistory]
SELECT [InvId]
      ,[LocId]
      ,[WhId]
      ,[ProdId]
	  ,([Increment] - [Decrement]) AS [QtyOnHand]
      ,[MovementDate]
FROM [APInventory].[Product].[InventoryTransaction]
GO

SELECT * FROM [Product].[InventoryMovementHistory]
GO
