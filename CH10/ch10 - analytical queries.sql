...
/****************************************************/
/* USE THIS TO CREATE A VIEW FOR REPORTING SERVICES */
/****************************************************/
...
DROP INDEX IF EXISTS iePlantLagFailures 
...
-- run the ALTER statements if the tables do not have the columns
-- THESE WERE EXECUTED WHEN WE LOADED THE DATABASE
...
SELECT * FROM [DimTable].[CalendarEnhanced]
GO
